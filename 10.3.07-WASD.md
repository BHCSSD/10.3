...
Show and tell the starter code first, the project is under the starter code. 
...
3. Add background image and a sprite instead of a square. Do this only if everything else is done. 
